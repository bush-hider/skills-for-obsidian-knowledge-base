...
Lists markdown files under Categories, Topics, and References.
"""
...
def print_structure(structure: dict[str, list[str]], as_json: bool) -> None:
    if as_json:
...
def main() -> int:
    ...
    print_structure(structure, args.json)
    return 0
